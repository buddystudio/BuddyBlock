...
public class DrawUtil 
{
    ...
    private final static double MIN_WIDTH = BDBParameters.minWidth;		// 窗口最小宽度
    private final static double MIN_HEIGHT = BDBParameters.minHeight;	// 窗口最小高
    
    public static void addDrawFunc(Stage stage, BorderPane root) 
    {
