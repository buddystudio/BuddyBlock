...
Blockly.Arduino['lists_create_empty_arduino'] = function(block) 
{
	//var list = block.getFieldValue('LIST1');
	...
	return [type + " " + list + '[' + num + '] = {}', Blockly.Arduino.ORDER_ATOMIC];
	*/
	
	return type + " " + list + '[' + num + '] = {};\n';
};

Blockly.Arduino['lists_getIndex_arduino'] = function(block) 
{
	var list = Blockly.Arduino.valueToCode(block, 'LIST',
      Blockly.Arduino.ORDER_COMMA) || '0';
	...
	return [list + '[' + num + ']', Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino['lists_setIndex_arduino'] = function(block) 
{
	var list = Blockly.Arduino.valueToCode(block, 'LIST',
      Blockly.Arduino.ORDER_COMMA) || '0';
