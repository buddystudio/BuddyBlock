...
Blockly.ZoomControls.prototype.createDom = function() 
{
  ...
  */
    ...
    this.svgGroup_ = Blockly.utils.createSvgElement('g', {'class': 'blocklyZoom2'},null);
    var clip;
    ...
    this.svgGroup_);
    //Blockly.utils.createSvgElement('rect',{'width': 32, 'height': 32, 'y': 77},clip);
    ...
    this.svgGroup_);
    zoomoutSvg.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', workspace.options.pathToMedia + Blockly.SPRITE.url);

    clip = Blockly.utils.createSvgElement('clipPath', {
        'id': 'blocklyZoominClipPath' + rnd
    },
    this.svgGroup_);
    //Blockly.utils.createSvgElement('rect',{'width': 32, 'height': 32, 'y': 43},clip);
    ...
    this.svgGroup_);
    zoominSvg.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', workspace.options.pathToMedia + Blockly.SPRITE.url);

    clip = Blockly.utils.createSvgElement('clipPath', {
        'id': 'blocklyZoomresetClipPath' + rnd
    },
    this.svgGroup_);
    //Blockly.utils.createSvgElement('rect',{'width': 32, 'height': 32},clip);
    ...
    this.svgGroup_);
    zoomresetSvg.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', workspace.options.pathToMedia + Blockly.SPRITE.url);

    // Attach event listeners.
    Blockly.bindEventWithChecks_(zoomresetSvg, 'mousedown', null,
    function(e) {
    ...
    Blockly.bindEventWithChecks_(zoominSvg, 'mousedown', null,
    function(e) {
        workspace.markFocused();
    ...
    Blockly.bindEventWithChecks_(zoomoutSvg, 'mousedown', null,
    function(e) {
        workspace.markFocused();
        workspace.zoomCenter( - 1);
        Blockly.Touch.clearTouchIdentifier(); // Don't block future drags.
