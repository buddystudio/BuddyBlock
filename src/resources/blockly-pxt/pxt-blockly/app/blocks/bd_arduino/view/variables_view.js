...
Blockly.Blocks.variables.HUE = "#ff6680";
...
Blockly.Blocks['variables_declare'] = {
  ...
  init: function() {
    ...
    this.appendValueInput('VALUE', null)
        .appendField(Blockly.BUDDY_DECLARE)
        .appendField(new Blockly.FieldTextInput('item'), 'VAR')
        .appendField(Blockly.BUDDY_AS)
	    ...
	    .appendField(Blockly.BUDDY_VALUE);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(Blockly.BUDDY_TOOLTIP_VARIABLES_DECLARE);
  },
  getVars: function() {
...
Blockly.Blocks['variables_get'] = {
  ...
  onchange: function() {
	  ...
	  if(Blockly.Arduino.definitions_['var_declare'+varName]){
		  ...
		  this.setWarningText(Blockly.BUDDY_WARNING_NOT_DECLARE);
	  }
  }*/
};
