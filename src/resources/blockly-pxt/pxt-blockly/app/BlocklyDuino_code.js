 ...
 * @private
 */
Code.TABS_ = ['blocks', 'javascript', 'php', 'python', 'dart', 'lua', 'arduino', 'xml', 'xml2', 'arduino2'];
...
{
	if (document.getElementById('tab_xml2').className == 'tabon') 
	{  
...
Code.renderContent = function() 
{
	...
	else if (content.id == 'content_xml2') 
	{
		var xmlTextarea = document.getElementById('content_xml2');
		var xmlDom = Blockly.Xml.workspaceToDom(Code.workspace);
		//var xmlText = Blockly.Xml.domToPrettyText(xmlDom);
		var xmlText = "hello world";
		var code =Blockly.Arduino.workspaceToCode(Code.workspace);
		xmlText=code;
		xmlTextarea.value = xmlText;
		xmlTextarea.focus();
	}
	else if (content.id == 'content_arduino2') 
	{
