...
// 创建自命名数组
Blockly.Blocks['lists_create_empty_arduino'] = 
{
  /**
   * Block for creating a empty list.
   * @this Blockly.Block
   */
  init: function() 
  {
    ...
    this.jsonInit({
      "message0": Blockly.Msg.LISTS_CREATE_EMPTY_TITLE + " %1 %2 %3 ",
	  "args0": [
        {
        "type": "input_value",
        "name": "LIST",
...
// 获取指定项数组的值
Blockly.Blocks['lists_getIndex_arduino'] = 
{
  /**
   * Block for get item from list.
   * @this Blockly.Block
   */
  init: function() 
  {
    ...
    this.jsonInit({
      "message0": Blockly.Msg.LISTS_GET_INDEX_INPUT_IN_LIST + " %1 " + Blockly.Msg.LISTS_GET_INDEX_GET + " %2 ",
	  "args0": [
        {
        "type": "input_value",
        "name": "LIST",
...
// 设置指定项数组的值
Blockly.Blocks['lists_setIndex_arduino'] = 
{
  /**
   * Block for get item from list.
   * @this Blockly.Block
  ...
  init: function() 
  {
    ...
    this.jsonInit({
      "message0": Blockly.Msg.LISTS_SET_INDEX_INPUT_IN_LIST + " %1 " + Blockly.Msg.LISTS_SET_INDEX_SET + " %2 %3",
	  "args0": [
        {
        "type": "input_value",
        "name": "LIST",
...
Blockly.defineBlocksWithJsonArray([  // BEGIN JSON EXTRACT
  ...
  {
    "type": "lists_isEmpty",
    "message0": "%1 %{BKY_LISTS_ISEMPTY_TITLE}",
    "args0": [
      {
        "type": "input_value",
        "name": "VALUE",
  ...
  {
    "type": "lists_length",
    "message0": "%{BKY_LISTS_LENGTH_TITLE} %1",
    "args0": [
      {
        "type": "input_value",
        "name": "VALUE",
