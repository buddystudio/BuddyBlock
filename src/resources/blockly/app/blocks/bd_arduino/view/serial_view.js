...
Blockly.Blocks['serial_write'] = {
    init: function () {
        ...
        this.appendValueInput("CONTENT", 'String')
            .appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
            .appendField(Blockly.BUDDY_SERIAL_WRITE);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
...
Blockly.Blocks['serial_print'] = {
  init: function() {
   this.setColour(Blockly.Blocks.serial.HUE);
    this.appendValueInput("CONTENT", 'String')
		.appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
        .appendField(Blockly.BUDDY_SERIAL_PRINT);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks['serial_println'] = {
   init: function() {
    ...
    this.appendValueInput("CONTENT", 'String')
		.appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
        .appendField(Blockly.BUDDY_SERIAL_PRINTLN);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip(Blockly.Msg.TEXT_PRINT_TOOLTIP);
  }
...
Blockly.Blocks['serial_print_hex'] = {
   init: function() {
    ...
    this.appendValueInput("CONTENT", 'Number')
		.appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
        .appendField(Blockly.BUDDY_SERIAL_PRINT_HEX)
        .setCheck('Number');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks['serial_parseInt_Float'] = {
  init: function() {
    ...
    this.setTooltip(function() {
      ...
      var TOOLTIPS = {
        'parseInt': Blockly.BUDDY_TOOLTIP_BLOCKGROUP_SERIAL_READ_INT,
        'parseFloat': Blockly.BUDDY_TOOLTIP_BLOCKGROUP_SERIAL_READ_FLOAT
      };
      return TOOLTIPS[op];
    });
  }
...
Blockly.Blocks['serial_flush'] = {
  init: function() {
   this.setColour(Blockly.Blocks.serial.HUE);
    this.appendDummyInput()
		.appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
        .appendField(Blockly.BUDDY_SERIAL_FLUSH);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
};
...
Blockly.Blocks['serial_event'] = {
    init: function () {
        ...
        this.appendDummyInput()
            .appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
            .appendField(Blockly.BUDDY_SERIAL_EVENT);
