...
Blockly.Blocks['ethernet_init_begin'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField(Blockly.BUDDY_ETHERNET_BEGIN)
        .appendField(new Blockly.FieldDropdown([[Blockly.BUDDY_ETHERNET, 'Ethernet'],[Blockly.BUDDY_ETHERNET2,'Ethernet2']]), "Ethernet");
...
Blockly.Blocks['ethernet_client_connect_server']={
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
    this.appendDummyInput()
        .appendField(Blockly.BUDDY_ETHERNET_CLINET_CONNECT_SERVER)
		.appendField(this.newQuote_(true))
        .appendField(new Blockly.FieldTextInput('buddy.studio'), 'SERVER')
...
Blockly.Blocks['ethernet_client_stop'] = {
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
    this.appendDummyInput()
        .appendField(Blockly.BUDDY_ETHERNET_CLINET_STOP);
...
Blockly.Blocks['ethernet_client_print'] = {
  init: function() {
	...
	this.appendValueInput('TEXT')
		.setCheck('String')
        .appendField(Blockly.BUDDY_ETHERNET_CLINET_PRINT);
	this.setPreviousStatement(true, null);
	this.setNextStatement(true, null);
	this.setInputsInline(true);
  }
...
Blockly.Blocks['ethernet_client_println'] = {
  init: function() {
	...
	this.appendValueInput('TEXT')
		.setCheck('String')
        .appendField(Blockly.BUDDY_ETHERNET_CLINET_PRINTLN);
	this.setPreviousStatement(true, null);
	this.setNextStatement(true, null);
	this.setInputsInline(true);
  }
...
Blockly.Blocks['ethernet_client_get_request']={
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
	this.appendDummyInput()
        .appendField(Blockly.BUDDY_ETHERNET_CLINET_GET_REQUEST);
    this.appendDummyInput()
        .appendField(Blockly.BUDDY_ETHERNET_CLINET_URL)
		.appendField(this.newQuote_(true))
        .appendField(new Blockly.FieldTextInput(''), 'URL')
        .appendField(this.newQuote_(false));
	this.appendDummyInput()
        .appendField(Blockly.BUDDY_ETHERNET_CLINET_SERVER)
		.appendField(this.newQuote_(true))
