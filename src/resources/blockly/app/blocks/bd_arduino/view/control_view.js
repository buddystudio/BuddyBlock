...
Blockly.Blocks['controls_for'] = {
    init: function() {
        this.setColour(Blockly.Blocks.loops.HUE);
        this.appendDummyInput().appendField(Blockly.LANG_CONTROLS_FOR_INPUT_WITH).appendField(new Blockly.FieldTextInput('i'), 'VAR');
        this.appendValueInput('FROM').setCheck('Number').setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.LANG_CONTROLS_FOR_INPUT_FROM);
        this.appendValueInput('TO').setCheck('Number').setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.LANG_CONTROLS_FOR_INPUT_TO);
        this.appendValueInput('STEP').setCheck('Number').setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.BUDDY_STEP);
        this.appendStatementInput('DO').appendField(Blockly.LANG_CONTROLS_FOR_INPUT_DO);
...
Blockly.Blocks.controls_whileUntil.OPERATORS = [[Blockly.LANG_CONTROLS_WHILEUNTIL_OPERATOR_WHILE, 'WHILE'], [Blockly.LANG_CONTROLS_WHILEUNTIL_OPERATOR_UNTIL, 'UNTIL']];

Blockly.Blocks['controls_flow_statements'] = {
    init: function() {
        this.setColour(Blockly.Blocks.loops.HUE);
        var dropdown = new Blockly.FieldDropdown(this.OPERATORS);
        this.appendDummyInput().appendField(dropdown, 'FLOW').appendField(Blockly.LANG_CONTROLS_FLOW_STATEMENTS_INPUT_OFLOOP);
        this.setPreviousStatement(true);
        var thisBlock = this;
        this.setTooltip(function() {
    ...
    onchange: function() {
        ...
        var block = this;
        do {
            if (block.type == 'controls_repeat' || block.type == 'controls_forEach' || block.type == 'controls_for' || block.type == 'controls_whileUntil') {
                legal = true;
                break;
            }
...
Blockly.Blocks.controls_flow_statements.OPERATORS = [[Blockly.LANG_CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK, 'BREAK'], [Blockly.LANG_CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE, 'CONTINUE']];
...
Blockly.Blocks['controls_if'] = {
   ...
   */
    init: function() {
        ...
        this.setColour(Blockly.Blocks.loops.HUE);
        this.appendValueInput('IF0').setCheck([Boolean, 'Number']).appendField(Blockly.Msg.CONTROLS_IF_MSG_IF);
   ...
   */
    domToMutation: function(xmlElement) {
        ...
        for (var i = 1; i <= this.elseifCount_; i++) {
            this.appendValueInput('IF' + i).setCheck([Boolean, 'Number']).appendField(Blockly.Msg.CONTROLS_IF_MSG_ELSEIF);
    ...
    compose: function(containerBlock) {
        ...
        while (clauseBlock) {
            ...
            case 'controls_if_elseif':
                this.elseifCount_++;
                var ifInput = this.appendValueInput('IF' + this.elseifCount_).setCheck([Boolean, 'Number']).appendField(Blockly.Msg.CONTROLS_IF_MSG_ELSEIF);
...
Blockly.Blocks['controls_mstimer2'] = {
    init: function() {
        this.setColour(Blockly.Blocks.loops.HUE);
        this.appendValueInput('TIME').setCheck('Number').setAlign(Blockly.ALIGN_RIGHT).appendField('MsTimer2').appendField(Blockly.BUDDY_MSTIMER2_EVERY);
        this.appendDummyInput().appendField('ms');
        this.appendStatementInput('DO').appendField(Blockly.BUDDY_MSTIMER2_DO);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
    }
};
...
Blockly.Blocks['controls_mstimer2_start'] = {
    init: function() {
        this.setColour(Blockly.Blocks.loops.HUE);
        this.appendDummyInput().appendField('MsTimer2').appendField(Blockly.BUDDY_MSTIMER2_START);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
    }
};
...
Blockly.Blocks['controls_mstimer2_stop'] = {
    init: function() {
        this.setColour(Blockly.Blocks.loops.HUE);
        this.appendDummyInput().appendField('MsTimer2').appendField(Blockly.BUDDY_MSTIMER2_STOP);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
    }
};
