...
public class BDCompileAndUploadCtrl
{
		...
		try
        {
	        ...
	        this.compileAndUploadWindow.getUpdateBtn().setOnAction(new EventHandler<ActionEvent>() 
			{
		        ...
		        public void handle(ActionEvent event) 
		        {
		            ...
		            if(compileAndUploadWindow.getSerialListCombox().getItems().get(0).equals("未连接"))
					{
	        ...
	        this.compileAndUploadWindow.getBoardListCombox().getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Object>()
	        {
	            ...
	            {
	                BDBParameters.boardType = compileAndUploadWindow.getBoardListCombox().getSelectionModel().getSelectedItem().toString();
	            }
	        });
        } 
		catch(Exception e) 
	...
	public void compileAndUpload()
	{
		...
		Task<String> dumpTask = new Task<String>() 
		{
            ...
            protected String call() throws Exception 
            {
                ...
                try 
                {
                	...
                	dumpMessage.setMessage("msg_" + ">>>>>>> BuddyBlock：" + BDLang.rb.getString("初始化操作即将开始") + "...");
                	dumpMessage.setMessage("msg_" + ">>>>>>> ===================================================================");
                	dumpMessage.setMessage("msg_" + "");*/
                	...
                	Platform.runLater(new Runnable() 
            		{
            		    ...
            		    public void run() 
            		    {
            		    	compileAndUploadWindow.getAcvView().setColorMsgFont("#000000");
			            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
			                compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>" + ">>>>>>> BuddyBlock：" + "初始化操作即将开始" + "..." + "</b>");
		...
		Task<String> compileTask = new Task<String>() 
		{
            ...
            protected String call() throws Exception 
            {
                ...
                try 
                {
                	...
                	compileMessage.setMessage("inf_" + ">>>>>>> BuddyBlock：" + BDLang.rb.getString("编译操作即将开始") + "...");
                	compileMessage.setMessage("inf_" + ">>>>>>> ===================================================================");
                	compileMessage.setMessage("inf_" + "");*/
                	...
                	Platform.runLater(new Runnable() 
            		{
            		    ...
            		    { 
            		    	compileAndUploadWindow.getAcvView().setColorMsgFont("#000000");
			            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
			                compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>" + ">>>>>>> BuddyBlock：" + "编译操作即将开始" + "..." + "</b>");
			                compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>>>>>>>> ===================================================================</b>");
			                compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
                        }
            		});
		...
		Task<String> uploadTask = new Task<String>() 
		{
            ...
            protected String call() throws Exception 
            {
            		...
            		Platform.runLater(new Runnable() 
            		{
            		    ...
            		    public void run() 
            		    {
            	            if(bd_com.equals("") || bd_com.equals("未连接"))
                        	{
			            		...
			            		compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
			                	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>>>>>>>> BuddyBlock：" + "请确认主控板已经连接计算机并选择了正确的串口序号" + "！</b>");
			                	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>>>>>>>> ===================================================================</b>");
			                	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
        		...
        		uploadMessage.setMessage("msg_" + ">>>>>>> BuddyBlock：" + BDLang.rb.getString("上传操作即将开始") + "...");
        		uploadMessage.setMessage("msg_" + ">>>>>>> ===================================================================");
        		uploadMessage.setMessage("msg_" + "");*/
            	...
            	Platform.runLater(new Runnable() 
        		{
        		    ...
        		    public void run() 
        		    {
            	    	compileAndUploadWindow.getAcvView().setColorMsgFont("#000000");
		            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
		            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>" + ">>>>>>> BuddyBlock：" + "上传操作即将开始" + "..." + "</b>");
		            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>>>>>>>> ===================================================================</b>");
		            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
                    }
        		});
                   	...
                   	{   
                        	...
                        	Platform.runLater(new Runnable() 
                    		{
                    		    ...
                    		    public void run() 
                    		    {
        	            	    	compileAndUploadWindow.getAcvView().setColorMsgFont("#FF0000");
        			            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
        			            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>>>>>>>> BuddyBlock：" + "上传操作已超时，所有操作已终止" + "！</b>");
        			            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>>>>>>>> ===================================================================</b>");
        			            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
                                }
                    		});
                ...
                try 
                {
                	...
                	{
                		//uploadMessage.setMessage("msg_" + "");
                		uploadMessage.setMessage("msg_" + "<b>>>>>>>> BuddyBlock：" + "准备重置串口" + "...</b>");
                    	...
                    	Thread.sleep(4000);
                    	uploadMessage.setMessage("msg_" + "<b>>>>>>>> BuddyBlock：" + "正在重置串口" + "...</b>");
                    	...
                    	uploadMessage.setMessage("msg_" + "<b>>>>>>>> BuddyBlock：" + "串口从" + " " + preCom + " " + "重置为" + " " + bd_com + "</b>");
                    	uploadMessage.setMessage("msg_" + "<b>>>>>>>> ===================================================================</b>");
                    	uploadMessage.setMessage("msg_" + "");

                    	
                    	compileAndUploadWindow.getProgressBar().setProgress(0.1);
                    	
                    	//System.out.println("BuddyBlock:正在重置串口... ");
                    ...
                    while((message = br2.readLine()) != null) 
                    {
			    		...
			    		else if(message.indexOf("avrdude done.  Thank you.") != -1)
			    		{
			    			...
			    			/*uploadMessage.setMessage("msg_" + "");
	                		uploadMessage.setMessage("msg_" + ">>>>>>> BuddyBlock：" + BDLang.rb.getString("上传操作已经结束") + "！");
	                		uploadMessage.setMessage("msg_" + ">>>>>>> ===================================================================");
			    			*/
			    			...
			    			Platform.runLater(new Runnable() 
		            		{
		            		    ...
		            		    public void run() 
		            		    {
		            		    	compileAndUploadWindow.getAcvView().setColorMsgFont("#000000");
					            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
					                compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>" + ">>>>>>> BuddyBlock：" +  "上传操作已经结束" + "</b>");
					                compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>>>>>>>> ===================================================================</b>");
					                //compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
		                        }
		            		});
				...
				Platform.runLater(new Runnable() 
				{
				    ...
				    public void run() 
				    {
				    	if(message.equals("COMPLETE"))
		                {
				    		...
				    		compileAndUploadWindow.getAcvView().setColorMsgFont("#000000");
				    		compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
		                	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>" + ">>>>>>> BuddyBlock：" + "初始化操作已结束" + "！" + "</b>");
		                	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>>>>>>>> ===================================================================</b>");
		                	//compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
				...
				Platform.runLater(new Runnable() 
				{
				    ...
				    public void run() 
				    {
				    	if(message.equals("COMPLETE"))
		                {
				    		compileAndUploadWindow.getAcvView().setColorMsgFont("#000000");
				    		compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
		                	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>" + ">>>>>>> BuddyBlock：" + "编译操作已结束" + "！" + "</b>");
		                	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>" + ">>>>>>> ===================================================================" + "</b>");
		                	//compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
		            	...
		            	else if(message.equals("ERROR"))
		            	{
		            		compileAndUploadWindow.getAcvView().setColorMsgFont("#FF0000");
		            		compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
		            		compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>" + ">>>>>>> BuddyBlock：" + "编译过程出现错误" + "！" + "</b>");
		            		compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>" + ">>>>>>> ===================================================================" + "</b>");
		            		//compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
	...
	public void updateSerialPorts()
	{
        ...
        BDBParameters.connectCom = this.compileAndUploadWindow.getSerialListCombox().getSelectionModel().getSelectedItem().toString();
	...
	public void stopAllThreads()
	{
		try
    	{
        	...
        	if(isAlive == true)
        	{
        		compileAndUploadWindow.getAcvView().setColorMsgFont("#FF0000");
        		compileAndUploadWindow.getAcvCtrl().updateMessageByLine("");
            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>>>>>>>> BuddyBlock：" + "所有操作已经终止" + "！</b>");
            	compileAndUploadWindow.getAcvCtrl().updateMessageByLine("<b>>>>>>>> ===================================================================</b>");
